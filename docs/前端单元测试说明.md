...
| `src/services/contributorRewardUtils.test.ts` | 贡献奖励工具：`formatScore`、`getLastTwoPeriods`、`periodToId`、`isPastClaimDeadline`（含 vi.useFakeTimers） |
...
**最后更新**：2026-02-10（新增 contributorRewardUtils 单元测试）
