...
**🌐 交易所网址**：[https://bite100.github.io/bite100/](https://bite100.github.io/bite100/)（GitHub Pages，推 main 即自动更新）
...
- **🔧 按功能优化**：全项目按功能改代码/文档时，先看 [设计文档索引 § 按功能模块查阅](./docs/设计文档索引.md#按功能模块查阅与-skill-对齐) 与 [.cursor/skills/p2p-dex-project/SKILL.md](./.cursor/skills/p2p-dex-project/SKILL.md)（功能 ↔ Skill ↔ 代码/文档对照，防止优化跑偏）
